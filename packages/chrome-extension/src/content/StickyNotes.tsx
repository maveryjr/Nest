...
const StickyNotes: React.FC<StickyNotesProps> = ({ isVisible, onToggle }) => {
  ...
  return (
    <>
      ...
      <div className="nest-sticky-controls">
         <button onClick={createNote} title="Add new sticky note">
           <Plus size={16} /> Add Note
         </button>
         <button onClick={onToggle} title="Close Sticky Notes">
           <X size={16} />
         </button>
      </div>
      {/* Sticky Notes */}
      ...
      <style jsx>{`
        ...
        .nest-sticky-controls button:hover {
          background: #d97706;
          transform: translateY(-2px);
        }

        .nest-sticky-controls button:active {
