...
const CommandPalette: React.FC<CommandPaletteProps> = ({
  ...
  const generateCommands = useCallback((searchQuery: string) => {
    ...
    allCommands.push({
      ...
      type: 'action',
      title: 'Ask Nest',
      subtitle: 'Chat with your knowledge corpus',
      icon: <MessageCircle size={16} />,
      action: () => {
        onOpenCorpusChat();
        onClose();
      },
      keywords: ['ask', 'nest', 'chat', 'corpus', 'ai', 'question']
    });
   ...
   }, [links, collections, onOpenLink, onAddToCollection, onCreateCollection, onSaveCurrentPage, onAddNote, onOpenTabSync, onClose, onOpenCorpusChat]);
