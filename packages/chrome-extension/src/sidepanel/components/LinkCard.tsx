...
import { ExternalLink, Edit3, Trash2, FolderPlus, MoreHorizontal, Tag, Mic, Camera } from 'lucide-react';
...
interface LinkCardProps {
  ...
  onOpenRichAnnotations: (type: 'link' | 'highlight', id: string) => void;
            ...
            <div className="dropdown">
              ...
              {showMenu && (
                <div className={`dropdown-menu ${menuPosition.positionUp ? 'position-up' : ''} ${menuPosition.positionLeft ? 'position-left' : ''}`}>
                  ...
                  <div className="dropdown-item" onClick={() => setShowTagEditor(true)}>
                    <Tag size={16} />
                    <span>Edit Tags</span>
                  </div>
                  <div className="dropdown-item" onClick={() => onOpenRichAnnotations('link', link.id)}>
                    <Mic size={16} />
                    <span>Add Voice Memo</span>
                  </div>
                  <div className="dropdown-item" onClick={() => onToggleScreenshot()}>
                    <Camera size={16} />
                    <span>Take Screenshot</span>
                  </div>
                  <div className="dropdown-separator"></div>
                  <div className="dropdown-item" onClick={() => setShowCollections(true)}>
                    <FolderPlus size={16} />
