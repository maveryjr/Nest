                ...
                {showMenu && (
                  <div className="dropdown-menu">
                    ...
                    <button onClick={() => {
                      ...
                      setShowMenu(false); // Hide main menu when opening collections
                    }} className="dropdown-menu-item">
                      <FolderPlus size={14} />
          ...
          <div className="link-card-body">
            {showCollections && (
              <div className="collections-menu">
                ...
                <button
                  onClick={() => {
                    onMoveToCollection(link.id, ''); // Assuming empty string removes from collection
                    setShowCollections(false);
                  }}
                  className="collection-option"
                >
            ...
            {showTagEditor && (
              <div className="tag-editor">
                ...
                {loadingTags ? (
                  ...
                  <TagInput
                    linkId={link.id} // Assuming TagInput can fetch its own tags now
                    onTagsUpdated={() => {
                      loadLinkTags(); // Reload this card's tags
